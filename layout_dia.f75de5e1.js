...
if (burger && mobileNav) {
    ...
    document.addEventListener('click', (event)=>{
        ...
        if (mobileNav.classList.contains('is-open') && !mobileNav.contains(target) && !burger.contains(target)) closeMenu();
    });
...
/* ------------------ Contact Form --------------- */ const contactForm = document.querySelector('#contact-form');
...
/* -------------- Theme Toggle -------------------- */ const themeToggle = document.querySelector('.theme-toggle');
